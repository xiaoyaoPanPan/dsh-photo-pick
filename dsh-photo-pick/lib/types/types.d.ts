...
export declare class PhotoPickError extends Error {
    readonly code: 'INVALID_ROOT' | 'ROOT_MISSING' | 'BUSY' | 'PATH_ESCAPE' | 'NOT_FOUND' | 'NO_CANDIDATES' | 'VISION_DISABLED' | 'VISION_UNAVAILABLE';
    /**
     * @param message - human-readable detail.
     * @param code - stable machine code.
     */
    constructor(message: string, code: 'INVALID_ROOT' | 'ROOT_MISSING' | 'BUSY' | 'PATH_ESCAPE' | 'NOT_FOUND' | 'NO_CANDIDATES' | 'VISION_DISABLED' | 'VISION_UNAVAILABLE');
}
