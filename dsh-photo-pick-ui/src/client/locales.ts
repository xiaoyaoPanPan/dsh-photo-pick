...
export const en = {
  ...
  title: 'Photo pick',
  intro:
    'Enable vision scoring and pick a look-at-images model from Settings → Models. '
  ...
  'panel.confirmDraftLeadWithCriteria':
    'Please run photo_pick_best on these similar photos. Pass the next Criteria line unchanged as the tool criteria parameter. Workspace-relative paths follow:',
  ...
  'panel.criteriaStepHint':
    'Optional for this pick only. Skip and confirm if you do not need extra rules; long-term standards stay under Scoring standard.',
  'panel.criteriaStepBack': 'Back',
  'panel.criteriaSection': 'This-batch criteria',
  'panel.criteriaActive': 'Set',
  'panel.criteriaHint':
    'Applies only to this pick (tool criteria). Long-term scoring rules stay under Scoring standard.',
  'panel.criteriaPlaceholder':
    'e.g. no bare legs; head near the upper third; prefer half-body',
  ...
  'panel.criteriaText.noLegs':
    'Do not show bare legs — photos with exposed legs should score much lower',
  'panel.criteriaText.halfBody':
    'Prefer half-body / chest-up framing — full-body shots with legs fully in frame score lower',
  'panel.criteriaText.headUpperThird':
    'Keep the head near the upper third of the frame (rule of thirds)',
  'panel.criteriaText.eyesOpen':
    'Both eyes open and clear — closed or half-closed eyes are a severe penalty',
  'panel.criteriaText.naturalSmile':
    'Prefer a natural smile — exaggerated expressions score lower',
  'panel.criteriaText.frontFacing':
    'Prefer front or slight three-quarter face — profile / back views score lower',
  'panel.criteriaText.cleanBackground':
    'Busy or distracting backgrounds that compete with the subject score lower',
  'panel.criteriaText.noHeadCrop':
    'Severe cropping of the crown or chin is a severe penalty',
  ...
  'panel.promptCustomHint':
    'Leave empty to use the default. Affects every pick. Per-batch needs go under This batch. The JSON suffix is always appended.',
  ...
  'compare.hintSplitPick':
    'Click a thumb to assign it to the focused side (L/R). Click a pane or its L/R badge to switch focus. Use − to pass into the recycle bin.',
...
export const zh = {
  ...
  title: '照片择优',
  intro:
    '开启视觉打分，并从「设置 → 模型」里已配置的路由中选择看图模型。'
  ...
  'panel.confirmDraftLeadWithCriteria':
    '请对这些近似照片调用 photo_pick_best 做择优，并把下一行「择优要求」原文原样传入 criteria 参数。路径如下：',
  ...
  'panel.criteriaStepHint':
    '只影响这一次择优，可不填直接确定。长期审美请改左侧「打分标准」。',
  ...
  'compare.hintSplitPick':
    '点缩略图指定到当前焦点侧（左/右）；点画面或 L/R 切换焦点。点 − 移入回收站，可从回收站加回。',
  'compare.positionSplit': '{a}–{b} / {n}',
  'compare.sideLeft': '左',
  'compare.sideRight': '右',
