 ...
 */
export function loadCriteriaDraft() {
    try {
 ...
 */
export function saveCriteriaDraft(text) {
    try {
 ...
 */
export function loadCriteriaHistory() {
    try {
 ...
 */
export function rememberCriteria(text) {
    const trimmed = text.trim();
    if (trimmed.length === 0)
        return loadCriteriaHistory();
    const next = [
        trimmed,
...
//# sourceMappingURL=criteria-history.js.map